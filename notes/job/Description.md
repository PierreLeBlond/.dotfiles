...
3 ans d'expérience en entreprise en développement informatique. Une joie pour le code, se manifestant à travers plusieurs projets personnels autour du développement fullstack, du rendu 3D ou encore du jeux vidéos. Actuellement en train de développer une activité en freelance. Je reste toutefois ouvert à toute opportunité d'emploi motivante sur Strasbourg, ou à distance.